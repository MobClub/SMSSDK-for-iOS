...
- (void)testSendCodeText
{
    ...
    [SMSSDK getVerificationCodeByMethod:0 phoneNumber:@"13818209557" zone:@"86" result:^(NSError *error) {
...
// 正常发送短信验证码
- (void)testSendCodeTextWithTemplate
{
    XCTestExpectation *expectation = [self expectationWithDescription:@"testSendCodeText"];

    [SMSSDK getVerificationCodeByMethod:0 phoneNumber:@"13818209557" zone:@"86" template:@"1319972" result:^(NSError *error) {
...
- (void)testSendCodeVoice
{
    ...
    [SMSSDK getVerificationCodeByMethod:1 phoneNumber:@"13818209557" zone:@"86" result:^(NSError *error) {
...
- (void)testSendCodeZoneRandom
{
    ...
    [SMSSDK getVerificationCodeByMethod:0 phoneNumber:@"13818209557" zone:@"123" result:^(NSError *error) {
...
- (void)testSendCodeNoBlock
{
    ...
    [SMSSDK getVerificationCodeByMethod:0 phoneNumber:@"13818209557" zone:@"+86" result:nil];
...
- (void)testSendCode100times
{
    ...
    {
        [SMSSDK getVerificationCodeByMethod:0 phoneNumber:@"18019741601" zone:@"86" result:^(NSError *error) {
...
// 正常发送短信验证码
- (void)testSendCodeTextUs
{
//    XCTestExpectation *expectation = [self expectationWithDescription:@"testSendCodeTextUs"];
//
...
- (void)testCommitCode
{
    ...
    NSString *code = @"437055";

    [SMSSDK commitVerificationCode:code phoneNumber:@"13818209557" zone:@"86" result:^(NSError *error) {
        SMSLog(@"%@",error);
        XCTAssert(!error);
        [expectation fulfill];
    }];
...
- (void)testCommitCodeNoBlock
{
    ...
    NSString *code = @"409664";
    
    [SMSSDK commitVerificationCode:code phoneNumber:@"13818209557" zone:@"86" result:nil];
...
- (void)testCommitUsCode
{
    //    [self testSendCodeText];
    
    XCTestExpectation *expectation = [self expectationWithDescription:@"testCommitCodeUs"];

    NSString *code = @"151703";
