//
//  SMSSDKUIZonesResultViewController.m
//  SMSSDKUI
//
...
@interface SMSSDKUIZonesResultViewController ()<UITableViewDelegate,UITableViewDataSource, UIScrollViewDelegate>
...
@implementation SMSSDKUIZonesResultViewController
...
- (void)configUI
{
    ...
    [self.tableView registerClass:[SMSSDKUIZonesCell class] forCellReuseIdentifier:kCountryZoneResultCellIdentifier];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SMSSDKUIZonesCell *cell = [tableView dequeueReusableCellWithIdentifier:kCountryZoneResultCellIdentifier];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;

    if (!cell)
    {
        cell = [[SMSSDKUIZonesCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:kCountryZoneResultCellIdentifier];
    }
