...
- (void)viewDidLoad
{
    ...
    NSString *icon = [NSString stringWithFormat:@"BtnBackground.png"];
    ...
    versionLabel.text = [NSString stringWithFormat:@"V%@",[SMSSDK version]];
...
- (void)registerWithSpeechVerification
{
    ...
    [SMSSDKUI showVerificationCodeViewWithMethod:SMSGetCodeMethodVoice result:^(enum SMSUIResponseState state,NSString *phoneNumber,NSString *zone, NSError *error) {
