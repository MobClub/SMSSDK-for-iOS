...
- (void)configUI
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:[SMSSDK version] style:UIBarButtonItemStylePlain target:nil action:nil];
...
{
    SMSSDKUIGetCodeViewController *vc = [[SMSSDKUIGetCodeViewController alloc] initWithMethod:SMSGetCodeMethodVoice];
